...
export default function CompanySignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push('/company/login?message=Account created successfully. Please sign in.');
      } else {
        ...
        <div className="flex flex-col justify-center px-12 py-12 w-full">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300">
              Create your company account and start managing reimbursements efficiently.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#6B7280] dark:text-[#9CA3AF]">
              Set up your company's reimbursement management system
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-lg border border-[#E5E7EB] dark:border-[#333333] p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="companyName" className="block text-sm font-medium text-[#1F2937] dark:text-white mb-2">
                  Company Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <FiUser className="h-5 w-5 text-[#6B7280] dark:text-[#9CA3AF]" />
                  </div>
                  <input
                    id="companyName"
                    name="companyName"
              ...
              <div>
                <label htmlFor="contactName" className="block text-sm font-medium text-[#1F2937] dark:text-white mb-2">
                  Contact Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-[#1F2937] dark:text-white mb-2">
                  Phone Number
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <FiPhone className="h-5 w-5 text-[#6B7280] dark:text-[#9CA3AF]" />
                  </div>
                  <input
                    id="phone"
                    name="phone"
